...
<div class="wrapper" style="height: auto; min-height: 100%;">
    ...
    <div class="content-wrapper" style="min-height: 480px;margin-top: 50px">
        <section class="content-header" style="overflow: hidden">
            <h1 class="row" id="pageTitle" style="color:#0C0C0C; width: 50%;float: left; margin-bottom: 10px">添加用户</h1>
                            ...
                            <div class="box-body">
                                <div style="width: 45%;float: left">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="adminName" name="adminName" placeholder="请输入登入账号">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="adminNickname" name="adminNickname"
